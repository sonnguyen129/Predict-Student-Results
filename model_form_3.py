...
def app():
    st.markdown("<h2 align='center'>Dự đoán nguy cơ tốt nghiệp quá hạn và buộc thôi học</h2>", unsafe_allow_html=True)
    with st.form("Dự đoán nguy cơ tốt nghiệp quá hạn và buộc thôi học"):
        # form header
        ...
        if submit_val:
            ...
            with open('weights/model_3/preprocessor.pkl', 'rb') as file:
                preprocessor = pickle.load(file) 

            # model = XGBClassifier()
            with open('weights/model_3/model_best.pkl', 'rb') as f:
            ...
            target = ['Buộc Thôi học', 'Quá hạn', 'Đúng hạn']
